...
const Icon = () => {
  ...
  const colors = theme.isDarkTheme ? darkColors : lightColors;

  // Define the animation config
  const slideOutAnimation = useSpring({
    opacity: opacity,
    transform: isTransform ? "translateY(-20%)" : "translateY(0)",
  });
  ...
  const handleTransform = () => {
    ...
    setIsTransform(threshold > scrollY);
  };
